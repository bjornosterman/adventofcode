...
namespace Day25_Santa
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            machine.Output = c =>
            {
                if (c == '\n')
                {
                    ...
                    if (output.Contains("heavier")) story.Add("Too heavy");
                    if (output.Contains("lighter")) story.Add("Too light");
                        ...
                        do
                        {
                            ...
                            else
                            {
                                switch (key.Key)
                                {
                                    ...
                                    case ConsoleKey.I:
                                        int i = 1;
                                        if (inventory.Any() == false) Console.WriteLine("You have nothing in inventory");
        ...
        private static IEnumerable<string> ConstructTries(List<string> inventory)
        {
            ...
            var combos = Math.Pow(2, inventory.Count) - 1;
            for (int i = 0; i < combos; i++)
            {
                var testItems = Pick(inventory, i).ToList();
        ...
        private static IEnumerable<string> Pick(List<string> inventory, int combo)
        {
            int i = 0;
            while (combo > 0)
            {
                if (combo % 2 == 1) yield return inventory[i];
                i++;
                combo /= 2;
            }
        }
